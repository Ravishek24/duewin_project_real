...
import {
   ...
   * @param {Object} res - Express response object
   */
  export const getLaunchUrlController = async (req, res) => {
    try {
   ...
   * @param {Object} res - Express response object
   */
  export const infoCallbackController = async (req, res) => {
    try {
      // Verify the request signature
      const clientId = req.header('X-Spribe-Client-ID');
      const timestamp = req.header('X-Spribe-Client-TS');
   ...
   * @param {Object} res - Express response object
   */
  export const withdrawCallbackController = async (req, res) => {
    try {
      // Verify the request signature
      const clientId = req.header('X-Spribe-Client-ID');
      const timestamp = req.header('X-Spribe-Client-TS');
   ...
   * @param {Object} res - Express response object
   */
  export const depositCallbackController = async (req, res) => {
    try {
      // Verify the request signature
      const clientId = req.header('X-Spribe-Client-ID');
      const timestamp = req.header('X-Spribe-Client-TS');
