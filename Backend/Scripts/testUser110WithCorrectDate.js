// scripts/testUser110WithCorrectDate.js
const enhancedRebateService = require('../services/enhancedRebateService');
const unifiedRedis = require('../config/unifiedRedisManager');

async function testUser110WithCorrectDate() {
    try {
        console.log('🧪 Testing User 110 with Correct Date (2025-07-26)...');
