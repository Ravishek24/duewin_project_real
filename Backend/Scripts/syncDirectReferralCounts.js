 ...
 */
const syncDirectReferralCounts = async () => {
    let sequelize = null;
    
    try {
        console.log('🔄 Starting direct referral count sync...');
        ...
        for (const referrer of referrers) {
            try {
                ...
                console.log(`📊 User ${referrer.user_name} (${referrer.user_id}): current=${referrer.direct_referral_count}, actual=${actualReferralCount}`);
        ...
        console.log(`\n🎉 Direct referral count sync completed!`);
        ...
        console.error('💥 Error in direct referral count sync:', error);
        return {
            success: false,
...
module.exports = { syncDirectReferralCounts }; 