// scripts/testCronWithSpecificDate.js
const { processDailyRebates } = require('./masterCronJobs');
const unifiedRedis = require('../config/unifiedRedisManager');
const moment = require('moment-timezone');

async function testCronWithSpecificDate() {
    try {
        console.log('🧪 Testing Daily Rebate Cron with Specific Date...');
        ...
        console.log('\n🔄 Starting daily rebate processing with specific date...');
